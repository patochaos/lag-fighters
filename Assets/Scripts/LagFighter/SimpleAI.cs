        ...
        public List<int> Plan(MatchSim sim, int me, int turnFrames)
        {
            ...
            while (frames < budget)
            {
                ...
                else if (dist > 2.6f)
                {
                    ...
                    // con agachado activo: 0.82-0.89 era Crouch (el hadouken pasa de largo)
                    // else if (r < 0.89) pick = MoveCatalog.Crouch;
                ...
                else
                {
                    ...
                    // con agachado activo, el reparto era:
                    // A 0.16 · LowKick 0.26 · B 0.36 · Grab 0.48 · WalkB 0.56 ·
                    // Wait 0.62 · Crouch 0.66 · DashB 0.72 · DP 0.78 · Tatsu 0.84 · saltos
                }
